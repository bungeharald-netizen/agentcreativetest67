...
export default function Dashboard() {
  ...
  const stats = {
    ...
    activeProjects: analyses?.filter((a) => a.status === "in-progress").length || 0,
    totalROI: analyses?.reduce((acc, a) => acc + (a.total_investment || 0), 0) || 0,
    avgSuggestions:
      analyses && analyses.length > 0
        ? Math.round(
            analyses.reduce((acc, a) => acc + a.suggestions_count, 0) /
              analyses.length
          )
        : 0,
  };
  ...
  const formatCurrency = (amount: number) => {
    ...
    if (amount >= 1000) {
      return `${Math.round(amount / 1000)}k SEK`;
    }
    return `${amount} SEK`;
  };
            ...
            <>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {[
                  ...
                  {
                    label: "Snitt AI-förslag",
                    value: stats.avgSuggestions,
                    icon: Sparkles,
                    color: "text-success",
                  },
                  {
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                  ...
                  {/* Tips */}
                  <div
                    className="glass rounded-2xl p-6 border-primary/20 animate-slide-up"
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground">
                      Ju mer detaljerad information du ger om företaget, desto
                      bättre och mer relevanta blir AI-förslagen. Inkludera
                      utmaningar, mål och nuvarande system.
                    </p>
                  </div>
                </div>
